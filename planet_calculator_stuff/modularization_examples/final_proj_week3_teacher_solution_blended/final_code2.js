...
function showUserFactors(factorType, factorSystem, factorUnit, factorValue, factorPlanets) {
    const userResults = {};
...
function getUserFactors() {
    ...
    showUserFactors(factorType, factorSystem, factorUnit, factorValue, factorPlanets);
}
